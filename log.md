...
### Day 26: January 12, Sunday

**Today's Progress**: Refactored Project 3

**Thoughts**: I refactored a few things in my registration form project. I will continue this next time.
...
### Day 30: January 16, Thursday

**Today's Progress**: Refactored Project 3

**Thoughts**: Did some more refactoring. I cleaned up my code and comments, fixing any small errors.
...
### Day 50: February 11, Tuesday

**Today's Progress**: Started second half of Week 3 problem set

**Thoughts**: This problem was pretty complex, and I worked a full day today, so I'm going to finish up the problem tomorrow when I have a fresh brain!
...
### Day 55: February 16, Sunday

**Today's Progress**: Finished week 4 lecture. Started extra videos.
...
**Thoughts**: Today I bought some Udemy courses and started one of them.
...
### Day 22: April 15, Wednesday

**Today's Progress**: Continued Udemy course

**Thoughts**: Finished the 9th project on my udemy course, an expense tracker. I look forward to expanding on this project in the future.
...
### Day 49: May 15, Friday

**Today's Progress**: Continued Udemy course

**Thoughts**: Continued the React Front to Back course on Udemy. Continued the Contact Keeper app, adding the delete, edit and update contact methods. Also added the set and clear current contact methods.

**Link(s) to work**:

1. [React Front to Back](https://www.udemy.com/course/modern-react-front-to-back/)

### Day 50: May 16, Saturday

**Today's Progress**: Continued Udemy course

**Thoughts**: Continued the React Front to Back course on Udemy. Continued the Contact Keeper app, adding contact filtering, auth context, and the register and login components.

**Link(s) to work**:

1. [React Front to Back](https://www.udemy.com/course/modern-react-front-to-back/)

### Day 51: May 17, Sunday

**Today's Progress**: Continued Udemy course

**Thoughts**: Continued the React Front to Back course on Udemy. Continued the Contact Keeper app, adding alerts, user registration, login and logout features, and a PrivateRoute.

**Link(s) to work**:

1. [React Front to Back](https://www.udemy.com/course/modern-react-front-to-back/)

### Day 52: May 18, Monday

**Today's Progress**: Continued Udemy course

**Thoughts**: Continued the React Front to Back course on Udemy. Continued the Contact Keeper app, adding back end integration with the contacts components/context. Also deployed app to Heroku.
...
### Day 58: June 4, Thursday

**Today's Progress**: Continued rebuilding old project

**Thoughts**: Continued rebuilding my full stack app. I finished updating the CreateCourse components/functionality.
...
### Day 66: June 17, Wednesday

**Today's Progress**: Continued Udemy course

**Thoughts**: Continued the Master the Coding Interview course on Udemy. Finished the big O notation section.

**Link(s) to work**:

1. [Master the Coding Interview](https://www.udemy.com/course/master-the-coding-interview-data-structures-algorithms/)

### Day 67: June 20, Saturday

**Today's Progress**: Continued Udemy course

**Thoughts**: Continued the Master the Coding Interview course on Udemy. Finished the solving problems section.
